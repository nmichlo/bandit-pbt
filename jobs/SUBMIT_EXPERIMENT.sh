...
sbatch --array=1-10 -n1 -p ha -J '15ucbERA' -o 'logs/15_ucb_%A_%a.log' --wrap 'python -m tsucb.experiment  --comet-enable  --pbt-print  --experiment-name="15_ucbERA"  --pbt-members="15"  --pbt-exploit-suggest="ucb" --cnn-steps-per-epoch="1" --pbt-target-steps="7"  --pbt-members-ready-after="1" --cnn-lr-max="0.01"'
sbatch --array=1-10 -n1 -p ha -J '15ucbERA' -o 'logs/15_ucb_%A_%a.log' --wrap 'python -m tsucb.experiment  --comet-enable  --pbt-print  --experiment-name="15_ucbERA"  --pbt-members="15"  --pbt-exploit-suggest="ucb" --cnn-steps-per-epoch="1" --pbt-target-steps="7"  --pbt-members-ready-after="1" --cnn-lr-max="0.01"'

sbatch --array=1-25 -n1 -p ha -J '25_ran_REA' -o 'logs/25_ran_%A_%a.log' --wrap 'python -m tsucb.experiment  --comet-enable  --pbt-print  --experiment-name="25_ran_REA"  --pbt-members="15"  --pbt-exploit-suggest="ran" --cnn-steps-per-epoch="1" --pbt-target-steps="10"  --pbt-members-ready-after="1" --cnn-lr-max="0.01"'
sbatch --array=1-25 -n1 -p ha -J '25_ucb_REA' -o 'logs/25_ucb_%A_%a.log' --wrap 'python -m tsucb.experiment  --comet-enable  --pbt-print  --experiment-name="25_ucb_REA"  --pbt-members="15"  --pbt-exploit-suggest="ucb" --cnn-steps-per-epoch="1" --pbt-target-steps="10"  --pbt-members-ready-after="1" --cnn-lr-max="0.01"'
sbatch --array=1-25 -n1 -p ha -J '25_ucb_REAS' -o 'logs/25_ucb_%A_%a.log' --wrap 'python -m tsucb.experiment  --comet-enable  --pbt-print  --experiment-name="25_ucb_REAS"  --pbt-members="15"  --pbt-exploit-suggest="ucb" --cnn-steps-per-epoch="1" --pbt-target-steps="10"  --pbt-members-ready-after="1" --cnn-lr-max="0.01" --suggest-ucb-incr-mode="stepped"'
sbatch --array=1-25 -n1 -p ha -J '25_gr_REA' -o 'logs/25_gr_%A_%a.log' --wrap 'python -m tsucb.experiment  --comet-enable  --pbt-print  --experiment-name="25_gr_REA"  --pbt-members="15"  --pbt-exploit-suggest="gr" --cnn-steps-per-epoch="1" --pbt-target-steps="10"  --pbt-members-ready-after="1" --cnn-lr-max="0.01"'
sbatch --array=1-25 -n1 -p ha -J '25_sm_REA' -o 'logs/25_sm_%A_%a.log' --wrap 'python -m tsucb.experiment  --comet-enable  --pbt-print  --experiment-name="25_sm_REA"  --pbt-members="15"  --pbt-exploit-suggest="sm" --cnn-steps-per-epoch="1" --pbt-target-steps="10"  --pbt-members-ready-after="1" --cnn-lr-max="0.01"'
sbatch --array=1-25 -n1 -p ha -J '25_e-gr_REA' -o 'logs/25_e-gr_%A_%a.log' --wrap 'python -m tsucb.experiment  --comet-enable  --pbt-print  --experiment-name="25_e-gr_REA"  --pbt-members="15"  --pbt-exploit-suggest="e-gr" --cnn-steps-per-epoch="1" --pbt-target-steps="10"  --pbt-members-ready-after="1" --cnn-lr-max="0.01"'
sbatch --array=1-25 -n1 -p ha -J '25_e-sm_REA' -o 'logs/25_e-sm_%A_%a.log' --wrap 'python -m tsucb.experiment  --comet-enable  --pbt-print  --experiment-name="25_e-sm_REA"  --pbt-members="15"  --pbt-exploit-suggest="e-sm" --cnn-steps-per-epoch="1" --pbt-target-steps="10"  --pbt-members-ready-after="1" --cnn-lr-max="0.01"'
sbatch --array=1-25 -n1 -p ha -J '25_e-ucb_REA' -o 'logs/25_e-ucb_%A_%a.log' --wrap 'python -m tsucb.experiment  --comet-enable  --pbt-print  --experiment-name="25_e-ucb_REA"  --pbt-members="15"  --pbt-exploit-suggest="e-ucb" --cnn-steps-per-epoch="1" --pbt-target-steps="10"  --pbt-members-ready-after="1" --cnn-lr-max="0.01"'
sbatch --array=1-25 -n1 -p ha -J '25_e-ucb_REAS' -o 'logs/25_e-ucb_%A_%a.log' --wrap 'python -m tsucb.experiment  --comet-enable  --pbt-print  --experiment-name="25_e-ucb_REAS"  --pbt-members="15"  --pbt-exploit-suggest="e-ucb" --cnn-steps-per-epoch="1" --pbt-target-steps="10"  --pbt-members-ready-after="1" --cnn-lr-max="0.01" --suggest-ucb-incr-mode="stepped"'
